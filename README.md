...
I built a simple banking system in Java to strengthen my understanding of object‑oriented programming and software design. The program runs entirely from the command line and allows users to create accounts, deposit, withdraw, transfer funds, and save/load account data from a file.  
...
- **Tools Used**:  
  - Command line for compiling and running Java (`javac` and `java`)  
  - A text editor/IDE (VS Code or IntelliJ IDEA) for writing code  
...
These resources helped me understand Java syntax, OOP concepts, and file handling:
